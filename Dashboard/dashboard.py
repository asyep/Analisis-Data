...
# Mengurutkan DataFrame berdasarkan order_date dan memastikan tipe datetime pada order_date & delivery_date
...
# Gunakan main_df yang telah difilter untuk menghasilkan DataFrame lain untuk visualisasi data, 
# dengan memanggil helper function yang telah dibuat.
